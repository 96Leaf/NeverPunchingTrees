...
public class Tags {
    ...
    public static class Items {
        ...
        public static final TagKey<Item> TOOLS_AXES = tag("forge", "tools/axes");
        public static final TagKey<Item> TOOLS_HOES = tag("forge", "tools/hoes");
        public static final TagKey<Item> TOOLS_PICKAXES = tag("forge", "tools/pickaxes");
        public static final TagKey<Item> TOOLS_SHEARS = tag("forge", "tools/shears");
        public static final TagKey<Item> TOOLS_SHOVELS = tag("forge", "tools/shovels");
        public static final TagKey<Item> TOOLS_SWORDS = tag("forge", "tools/swords");
